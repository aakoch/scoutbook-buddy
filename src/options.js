import './options.scss'; // to get webpack to handle this
...
window.onload = function () { 
	...
	document.getElementById("NoNotify").onclick= function()  { setVal('0') };
	document.getElementById("MajorNotify").onclick= function()  { setVal('1') };
	document.getElementById("AllNotify").onclick= function()  { setVal('2') };	
}

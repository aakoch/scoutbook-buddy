    ...
    xhttp.onreadystatechange = function() {
        ...
        if (this.readyState == 4 && this.status == 200) {
            ...
            if (cb == true) {
                ...
                setTimeout(function() {
                    getNewPayIDQE(pageID, unitID, unitPayLogID, pageArray, true, descript, PaymentTypeIn);
                }, 200);
                return;
            }
            ...
            setTimeout(function() {
                updateUnitAccountQE(pageID, unitID, unitPayLogID, pageArray, cb, payid, PaymentTypeIn);
            }, 200);
    ...
    xhttp.onreadystatechange = function() {
        ...
        if (this.readyState == 4 && this.status == 200) {
            ...
            */
            ...
            setTimeout(function() {
                updateUnitAccountQE(pageID, unitID, unitPayLogID, pageArray, rFlag, idnum, PaymentTypeIn);
            }, 200);
        }
    };
...
function submitQuietPay(pageID, unitID) {
    ...
    xhttp.onreadystatechange = function() {
        ...
        if (this.readyState == 4 && this.status == 200) {
            ...
            if (unitScoutId != '') {
                setTimeout(function() {
                    updateUnitAccount(pageID, unitID, scoutid, payVal, false, '', sNote);
                }, 200);
                return;
            }
    ...
    xhttp.onreadystatechange = function() {
        ...
        if (this.readyState == 4 && this.status == 200) {
            ...
            if (cb == true) {
                ...
                setTimeout(function() {
                    getNewPayID(pageID, unitID, scoutid, payVal, true, descript, sNote);
                }, 200);
                return;
            }
    ...
    xhttp.onreadystatechange = function() {
        ...
        if (this.readyState == 4 && this.status == 200) {
            ...
            */
            ...
            setTimeout(function() {
                updateUnitAccount(pageID, unitID, scoutid, payVal, rFlag, idnum, sNote);
            }, 200);
        }
    };
...
function procPayQuickEntryItemNewRos(pageid, unitID, denID, patrolID) {
    ...
    xhttp.onreadystatechange = function() {
        ...
        if (this.readyState == 4 && this.status == 200) {
            ...
            setTimeout(function() {
                procPayQuickEntryItemNew(pageid, unitID, denID, patrolID, rosterIDs);
            }, 200);
        }
    };
...
*/
function xwrapper() {
    $('[name=PaymentType]', '#PageX').change(function() {
...
function pregetPaymentLogIDLI(pageId, handle, unitID) {
    ...
    $.mobile.loading('show', {
        theme: 'a',
        text: 'loading Apply Payment To choices...',
        textonly: false
    });
...
function zeroScoutAccount(pageid, unitID, scoutid, removedscoutid, transCnt, payArray) {
    ...
    xhttp.onreadystatechange = function() {
        ...
        if (this.readyState == 4 && this.status == 200) {
            ...
            transCnt += 1;
            setTimeout(function() {
                zeroScoutAccount(pageid, unitID, scoutid, removedscoutid, transCnt, payArray);
            }, 200);

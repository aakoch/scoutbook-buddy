...
function getDateEventIds(dateLst,calPageId,pageid) {
	...
	var evData={csv:'"Calendar","EventType","Name","Location","StartDate","StartTime","EndDate","EndTime","RSVP","Permission","Leaders","Parents","Scouts","Description","Reminders","mapURL"\n',
	Calendar:'',EventType:'',Name:'',Location:'',StartDate:'',StartTime:'',EndDate:'',EndTime:'',RSVP:'',Permission:'',Leaders:'',Parents:'',Scouts:'',Description:'',Reminders:'',cids:[],mapURL:''
	};
	var xhttp = new XMLHttpRequest();
	xhttp.onreadystatechange = function() {
		if (this.readyState == 4 && this.status > 399  && this.status < 500) {
